...
public interface ISoftwareService
{
    ...
    Task<bool> UninstallInteractiveAsync(string host, string username, string password, string uninstallString, int? sessionId = null, CancellationToken ct = default);
